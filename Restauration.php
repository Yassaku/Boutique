...
// Récupérer uniquement les produits de la catégorie "Restauration"
$stmt = $pdo->prepare("SELECT * FROM produits WHERE categorie = 'Restauration' ORDER BY date_ajout DESC");
$stmt->execute();
...
<head>
    ...
    <title>Restauration - Multi-Confection</title>
...
<header class="bg-white shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <div class="flex items-center space-x-4">
            ...
            <a href="Restauration.php" class="font-semibold text-indigo-600">Restauration</a>
...
<section class="bg-gradient-to-r from-green-500 to-teal-600 text-white py-16">
    <div class="container mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">Vêtements de Travail pour la Restauration</h1>
        <p class="text-xl mb-6">Tenues professionnelles élégantes, confortables et résistantes pour les cuisiniers, serveurs et personnel de restauration.</p>
...
<section id="products" class="py-12">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-8">Produits Restauration</h2>

        <?php if (empty($produits)): ?>
            <p class="text-center text-gray-600">Aucun produit disponible dans la catégorie "Restauration" pour le moment.</p>
        <?php else: ?>
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <?php else: ?>
                                        <span class="text-indio-600 font-bold"><?= number_format($produit['prix'], 2) ?> MAD</span>
                                    <?php endif; ?>
                                </div>
                                <button class="view-product-btn"
                                        ...
                                        data-colors='[
                                            ...
                                            $colors = [
                                                ...
                                                ["name" => "Rouge", "image" => "images/" . pathinfo($produit['image'], PATHINFO_FILENAME) . " (3).jpg"],
                                                ["name" => "Vert", "image" => "images/" . pathinfo($produit['image'], PATHINFO_FILENAME) . " (4).jpg"]
                                            ];
                                            $validColors = [];
