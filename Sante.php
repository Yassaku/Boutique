...
$host = 'localhost';
$dbname = 'boutique'; // Remplace par ton nom de base si différent
$user = 'root';
$pass = '';
...
// Récupérer uniquement les produits de la catégorie "Santé"
$stmt = $pdo->prepare("SELECT * FROM produits WHERE categorie = 'Santé' ORDER BY date_ajout DESC");
$stmt->execute();
...
<head>
    ...
    <title>Santé - Multi-Confection</title>
...
<header class="bg-white shadow-md sticky top-0 z-50">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        <div class="flex items-center space-x-4">
            ...
            <a href="Sante.php" class="font-semibold text-indigo-600">Santé</a>
...
<!-- Hero Section -->
<section class="bg-gradient-to-r from-green-500 to-blue-600 text-white py-16">
    <div class="container mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-bold mb-4">Équipement Médical et de Santé</h1>
        <p class="text-xl mb-6">Vêtements et protections professionnels pour le personnel médical, les infirmiers, laborantins et établissements de santé.</p>
        <a href="#products" class="bg-white text-green-600 px-6 py-3 rounded-md font-semibold hover:bg-gray-100 inline-block">Voir les produits</a>
    </div>
</section>
...
<section id="products" class="py-12">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-8">Produits Santé</h2>

        <?php if (empty($produits)): ?>
            <p class="text-center text-gray-600">Aucun produit disponible dans la catégorie "Santé" pour le moment.</p>
        <?php else: ?>
                                ...
                                <button class="view-product-btn"
                                        ...
                                        data-colors='[
                                            ...
                                            $colors = [
                                                ...
                                                ["name" => "Bleu", "image" => "images/" . pathinfo($produit['image'], PATHINFO_FILENAME) . " (1).jpg"],
                                                ["name" => "Vert", "image" => "images/" . pathinfo($produit['image'], PATHINFO_FILENAME) . " (2).jpg"],
                                                ["name" => "Rose", "image" => "images/" . pathinfo($produit['image'], PATHINFO_FILENAME) . " (3).jpg"]
                                            ];
                                            $validColors = [];
